...
export const testConfigs: TestConfig[] = [
	...
	groupTest500Nodes,
	/**
	 * FIXME: Disable 1000 nodes test suite for now since the time request is reached the timeout of the request which causes the Gateway Time-out error
	 * Revert until A12S-2634 is done
	 */
	// groupTest1000Nodes,
	groupTestPreload
];
