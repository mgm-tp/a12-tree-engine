...
export function createDefaultSagasMap(setting: TreeEngineSaga.Setting) {
	return {
		...
		watchChildNodeCreation: fn((activityId) => watchChildNodeCreationSaga(activityId, setting.linkCreation)),
		watchSiblingNodeCreation: fn((activityId) => watchSiblingNodeCreationSaga(activityId, setting.linkCreation)),
