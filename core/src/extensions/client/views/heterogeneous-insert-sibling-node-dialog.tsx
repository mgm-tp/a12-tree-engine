...
import type { InsertSiblingNodeDialog } from "../../../core/view/components/dialogs/sub-components/insert-sibling-node-dialog.js";
...
export namespace HeterogeneousInsertSiblingNodeDialog {
	export type Props = InsertSiblingNodeDialog.Props;
}

export const HeterogeneousInsertSiblingNodeDialog: React.FC<HeterogeneousInsertSiblingNodeDialog.Props> = (props) => {
	const { button, insertPosition, options } = props.dialogState;
	...
	const onSelect = useInsertOnSelect(options, insertPosition, button, "sibling");
	const { ActionContentBox, Title, HeadingAddon, ModalOverlay, CloseButton } = useWidgetMapComponents();
	const insertTitle = useDialogInsertTitle("sibling");
