...
import { type DataState, type Identifier, type ModelsState, TreeEngineState } from "../../../../core/store/store.js";
...
import { PasteEvent } from "../../../../core/view/shared.js";
...
function* buildCopyNodesOperations(params: Params): SagaGenerator<TreeEngineOperation.CopyNode[]> {
	...
	for (const source of clipboard.nodes) {
		let node: TreeEngineOperation.CopyNode.Node | undefined;
