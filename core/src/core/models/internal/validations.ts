...
export function isValidSubHeaderType(json: object): json is TreeModel.SubHeaderType {
	...
	return !!validate(object, "subHeader")
		.hasRequiredField("majorElements", isValidElementList)
		.hasRequiredField("minorElements", isValidElementList);
}
...
export function isValidFooterType(json: object): json is TreeModel.FooterType {
	...
	return !!validate(object, "footerBox")
		.hasRequiredField("majorElements", isValidButtonElementList)
		.hasRequiredField("minorElements", isValidButtonElementList);
}
...
export function isValidNodes(json: object): json is TreeModel.TreeNode[] {
	...
	return json.every((node) => {
		return (
			!!validate(node, "node")
				.hasOptionalField("defaultRowAction", isValidDefaultRowAction)
...
export function isValidNodeInheritConfiguration(
	...
	return !!validate(json, "node inherit configuration")
		...
		.hasOptionalField("defaultRowAction", isObject)
...
/** @internal */
export function isValidDefaultRowAction(json: object): json is TreeModel.DefaultRowAction {
	return !!validate(json, "default row action").hasRequiredField("custom").hasRequiredField("event");
}
