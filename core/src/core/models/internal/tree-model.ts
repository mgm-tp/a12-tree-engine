...
import { type IconTheme } from "@com.mgmtp.a12.widgets/widgets-core/lib/icon/index.js";
import {
...
export namespace RuntimeTreeModel {
	...
	export interface TreeNodeColumn extends TreeModel.TreeNodeColumn {
		/**
		 * The same as {@link elementRef} but it is also a JSON-friendly way to quickly determine the value.
		 * This property will be generated by {@link elementRef} when marshaling, modeler doesn't have to include this property.
		 */
