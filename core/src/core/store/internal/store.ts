...
import { type Relationship, type ModelGraph } from "@com.mgmtp.a12.dataservices/dataservices-access";
...
export namespace Identifier {
	...
	export function from(instance: string | Relationship.LinkEntitySpecResponse): Identifier {
		...
		if (!instance.docRef) {
			throw TreeEngineError.TypeError("RelationshipModel.LinkEntitySpec", { actual: instance, expect: "docRef" });
		}
		return {
			id: instance.docRef,
			type: instance.modelName
		};
	}
