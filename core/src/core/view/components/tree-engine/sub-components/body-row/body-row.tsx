		...
		return (
			<>
				{DefaultTreeTableComponentRenderers.bodyRowRenderer({
					...props,
					// Pass undefined (not true) when not readonly so useRowStyling in tree-engine-renderer controls interactivity (e.g. non_interactive rows).
					interactive: readonly ? false : undefined,
					disabled,
					onKeyDown,
