...
import { GlobalStyles, shouldForwardProp } from "@com.mgmtp.a12.widgets/widgets-core";
...
export const withTheme = <T extends A12ApplicationConfig>(cfg: T) => addWrapper<T>(ThemeWrapper, "outer")(cfg);
