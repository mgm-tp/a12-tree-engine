...
All relevant classes, instances and typings/type guards are hosted by link:./assets/generated/typedoc/modules/core_error.TreeEngineError.html[TreeEngineError namespace] along with the link:./assets/generated/typedoc/enums/core_error.TreeEngineErrorCode.html[TreeEngineErrorCode enumeration].
