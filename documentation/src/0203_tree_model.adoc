...
Tree Model can be created and modelled by SME. For more details, please refer to link:/docs/SME/sme-tm-ba-docs/index.html[SME documentation for Tree Model].
