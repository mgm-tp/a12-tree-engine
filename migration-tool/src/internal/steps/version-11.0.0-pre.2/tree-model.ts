...
export namespace TreeModel {
	...
	export interface CustomEventRowActivation {
		readonly type: "custom";
		readonly event: string;
	}
	export namespace CustomEventRowActivation {
		export function isAssignableFrom(activation: object): activation is CustomEventRowActivation {
			return "type" in activation && (activation as CustomEventRowActivation).type === "custom";
		}
	}
	...
	export type RowActivation =
		| EventRowActivation
		| InsertRowActivation
		| CustomEventRowActivation
		| NonInteractiveRowActivation;
